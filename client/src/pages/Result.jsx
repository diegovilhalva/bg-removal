      ...
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        </div>
        {
          resultImage && <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
            ...
            <a href={resultImage} download className="px-8 py-2.5 text-sm bg-gradient-to-r from-violet-600 to-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700">Download image</a>
          </div>
        }
