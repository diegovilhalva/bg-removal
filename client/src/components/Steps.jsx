        ...
        <div className='flex items-start flex-wrap gap-4  mt-16 xl:mt-24 justify-center'>
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500 '>
                ...
                <div >
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Start by uploading the image  <br /> you’d like to use. {" "}</p>
                </div>
            </div>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div >
                    ...
                    <p className='text-sm text-neutral-500 mt-1'> The background is  automatically  <br />removed from your image.</p>
                </div>
            </div>
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div >
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Finally, download your image  <br/>   with the background removed.</p>
                </div>
            </div>
        </div>
    </div>
